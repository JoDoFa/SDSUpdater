...
export default function Sidebar({ onLogout }) {
  ...
  const icons = {
    ...
    student: (
      <svg width="22" height="22" fill="none" viewBox="0 0 22 22">
        <path d="M11 11c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" fill="white"/>
      </svg>
    ),
    violation: (
      <svg width="22" height="22" fill="none" viewBox="0 0 22 22">
      ...
      {!collapsed && (
        <div className="rcc-footer">
          <div className="rcc-user">
            <div className="rcc-user-badge">OSA</div>
            <div className="rcc-user-name">Office of Student Affairs</div>
          </div>
