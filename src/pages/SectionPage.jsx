...
const initialSections = [
  { section: "Section A", type: "Student" },
  { section: "Section B", type: "Student" },
  { section: "Section C", type: "Student" },
  { section: "Section D", type: "Student" },
];
...
export default function SectionPage() {
  ...
  // ---- ADD ----
  const handleAdd = () => {
    const updated = [...sections, formData];
    setSections(updated);
  ...
  const handleExport = () => {
    const csv = [
      ["Section", "Type"],
      ...sections.map((s) => [s.section, s.type]),
    ]
      .map((row) => row.join(","))
      .join("\n");
